...
/* ─── Peserta Card ─────────────────────────────── */
.kps-peserta-card { border-radius: 10px; padding: clamp(0.6rem, 1.5vw, 0.85rem) 1rem; margin-bottom: clamp(0.5rem, 1vw, 0.75rem); text-align: center; }
.kps-peserta-card.blue { background: linear-gradient(135deg, rgba(21,101,192,0.12) 0%, rgba(21,101,192,0.04) 100%); border: 1px solid rgba(21,101,192,0.15); }
.kps-peserta-card.red { background: linear-gradient(135deg, rgba(198,40,40,0.12) 0%, rgba(198,40,40,0.04) 100%); border: 1px solid rgba(198,40,40,0.15); }
