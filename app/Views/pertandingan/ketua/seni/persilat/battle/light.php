...
<div id="kp-seni-app">
	<div class="kps-header">
		...
		<div class="kps-header-card"><?= esc($penampilan_seni_berlangsung->jenis_seni ?? '') ?> <span class="kps-hc-sep">—</span> <?= esc($penampilan_seni_berlangsung->nama_seni ?? 'Seni') ?> <span class="kps-hc-sep">—</span> <?= ($penampilan_seni_berlangsung->jenis_kelamin ?? '') === 'Putra' ? 'Putra' : 'Putri' ?> <span class="kps-hc-sep">—</span> Battle · Pool <?= esc($penampilan_seni_berlangsung->nomor_pool ?? '-') ?></div>
	</div>
