...
<div id="kp-seni-app">
	...
	<div class="tab-content kps-tab-content">
		...
		<div class="tab-pane active" id="blue_corner" role="tabpanel">
			...
			<div class="kps-stats-grid penampilan_seni_<?= $idB ?>"><div class="kps-stat-card"><div class="kps-stat-label">Median</div><div class="kps-stat-value median_<?=$idB?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Penalty</div><div class="kps-stat-value hukuman_<?=$idB?>">0</div></div><div class="kps-stat-card final-blue"><div class="kps-stat-label">Final</div><div class="kps-stat-value nilai_akhir_<?=$idB?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Std Dev</div><div class="kps-stat-value standar_deviasi_<?=$idB?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Med Keb</div><div class="kps-stat-value kebenaran_median_<?=$idB?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Time</div><div class="kps-stat-value waktu_<?=$idB?>">0</div></div></div>
		...
		<div class="tab-pane" id="summary" role="tabpanel">
			<div class="row g-2">
				...
				<div class="col-12 col-md-6"><div class="kps-peserta-card blue penampilan_seni_<?=$ids?>"><p class="kps-peserta-nama"><?=str_replace('<br>',' ',$p->anggota_kelompok_peserta_seni??'-')?></p><p class="kps-peserta-kontingen"><?=$p->nama_kontingen??'-'?></p></div><div class="kps-stats-grid penampilan_seni_<?=$ids?> blue-corner"><div class="kps-stat-card"><div class="kps-stat-label">Med</div><div class="kps-stat-value median_<?=$ids?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Pen</div><div class="kps-stat-value hukuman_<?=$ids?>">0</div></div><div class="kps-stat-card final-blue"><div class="kps-stat-label">Final</div><div class="kps-stat-value nilai_akhir_<?=$ids?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Std</div><div class="kps-stat-value standar_deviasi_<?=$ids?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">MK</div><div class="kps-stat-value kebenaran_median_<?=$ids?>">0</div></div><div class="kps-stat-card"><div class="kps-stat-label">Time</div><div class="kps-stat-value waktu_<?=$ids?>">0</div></div></div></div>
