...
<div id="kp-seni-app">
	<div class="kps-header">
		...
		<div class="kps-header-card"><div class="kps-hc-left"><div class="kps-hc-label"><i class="fas fa-user"></i> <?= ($penampilan_seni_berlangsung->jenis_kelamin ?? '') === 'Putra' ? 'Putra' : 'Putri' ?> · <?= esc($penampilan_seni_berlangsung->nama_kategori_usia ?? '') ?></div><div class="kps-hc-sub">Battle · Pool</div></div><div class="kps-hc-number"><span class="kps-hc-num-value"><?= esc($penampilan_seni_berlangsung->nomor_pool ?? '-') ?></span></div></div>
	</div>
