...
<?php
    ...
    $aksiHukuman = [
        ...
        ['label' => 'Teguran 2',    'mode' => 'teguran_2',    'jumlah' => -2,  'cls' => 'warn',   'icon' => 'fa-comment-exclamation'],
...
<div class="kp-wrapper" id="kp-wrapper"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-white border-warning">
            ...
            <div class="modal-body text-center py-4">
                <p class="fs-5 mb-3">Apakah jatuhan pada sudut <span id="verifikasi-jatuhan-sudut" class="fw-bold text-uppercase"></span> valid?</p>
                <small class="text-muted">Berdasarkan voting mayoritas juri</small>
            </div>
            <div class="modal-footer border-warning justify-content-center gap-3">
                <button type="button" class="btn btn-success btn-lg px-5" data-jawaban="valid">
                    <i class="fas fa-check me-2"></i>Valid
                </button>
                <button type="button" class="btn btn-danger btn-lg px-5" data-jawaban="tidak_valid">
...
<div class="modal fade" id="modalVerifikasiPelanggaran" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-white border-warning">
            ...
            <div class="modal-body text-center py-4">
                <p class="fs-5 mb-3">Apakah pelanggaran pada sudut <span id="verifikasi-pelanggaran-sudut" class="fw-bold text-uppercase"></span> valid?</p>
                <small class="text-muted">Berdasarkan voting mayoritas juri</small>
            </div>
            <div class="modal-footer border-warning justify-content-center gap-3">
                <button type="button" class="btn btn-success btn-lg px-5" data-jawaban="valid">
