    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-sm table-striped table-bordered text-center align-middle mb-0" id="tabel-nilai-seni">
...
<script>
// TODO: Implement DataTables AJAX loading for daftar nilai seni
// Endpoint: ketua-pertandingan/api/daftar-nilai-seni (to be created)
</script>
<?= $this->endSection() ?>
