...
<div class="juri-seni-wrapper terperinci-mode" id="juri-seni-wrapper"
    ...
    <header class="juri-seni-topbar">
        ...
        <div class="d-flex align-items-center gap-3">
            <a href="<?= base_url('juri/seni/sederhana') ?>" class="btn btn-sm btn-outline-light" title="Mode Sederhana">
    ...
    <!-- Main Scoring Area (expanded detail) -->
    <div class="seni-scoring-body terperinci <?= $aksesLocked ? 'is-locked' : '' ?>" id="scoring-body">

        <!-- Kebenaran: full detail per gerakan per jurus -->
        <div id="unsur-nilai-container" class="terperinci-grid">
            <!-- Rendered by JS — shows every individual gerakan cell -->
        </div>

        <!-- Hukuman Section (read-only) -->
